var leaderboardState = function(game){
    ...
    this.styleTextH = { font: "bold 48px Arial", fill: "#fff", boundsAlignH: "center", boundsAlignV: "middle" };
...
leaderboardState.prototype = {
	...
	//User Inteface
	    ...
	    scoreText = this.add.text(5, 5, 'Tabla',this.styleTextH); 
...
this.game.state.start('Menu');
        ...
        var playerScore;
            ...
            if(localStorage.getItem('highscore')===null){
                ...
                playerScore = this.add.text(this.world.centerX,180,'Mayor puntuacion - '+localStorage.getItem('highscore'),this.textStyle);
                playerScore.anchor.setTo(0.5,0.5);
            
     var currentScore = this.add.text(this.world.centerX,250,'Tu puntuacion - '+game.global.score,this.textStyle);
